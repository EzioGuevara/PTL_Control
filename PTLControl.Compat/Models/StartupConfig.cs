namespace PTLControl.Compat.Models
{
    ...
    {
        /// <summary>serial 或 mqtt</summary>
        public string ConnectionMode { get; set; } = "serial";
    public string LogLevel { get; set; } = "Info";
        public SerialStartupConfig Serial { get; set; } = new SerialStartupConfig();
        public MqttStartupConfig Mqtt { get; set; } = new MqttStartupConfig();
        public WirelessDefaultsConfig WirelessDefaults { get; set; } = new WirelessDefaultsConfig();
    }
